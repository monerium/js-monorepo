...
## [0.1.0](https://github.com/monerium/js-monorepo/compare/customer-v0.0.2...customer-v0.1.0) (2024-06-20)
...
* The following workspace dependencies were updated
  ...
  * devDependencies
    * @monerium/sdk bumped to 2.13.1
    * @monerium/sdk-react-provider bumped to 0.1.3
    * @repo/eslint-config bumped to 0.1.0
    * @repo/postcss-config bumped to 0.0.2
    * @repo/stylelint-config bumped to 0.0.2
