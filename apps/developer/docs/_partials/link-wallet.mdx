...
const rawMessage = 'I hereby declare that I am the address owner.';
// Safe signMessage expects the Safe/EIP-191 personal-sign hash. See SafeProtocolKit documentation.
  ...
  transactions: [
    {
      ...
      value: '0',
      data: signMessageLib.encode('signMessage', [messageHash]),
