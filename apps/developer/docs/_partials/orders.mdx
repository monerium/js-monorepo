...
| :---------------- | :---------------------------------- | :-------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `memo`            | Unstructured remittance information | Free text, 5–140 chars                                 | Human-readable note visible on the recipient's bank statement. Use for payment descriptions, invoice notes, or any context for the recipient.                                |
...
// order.state: 'placed' | 'pending' | 'processed' | 'rejected'
});`}</CodeBlock>
