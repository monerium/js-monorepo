...
[Read our API specifications](./api)
...
Register your application and start using the Monerium services for free. We have documented [how to get started](./getting-started), and if you run into any problems, don't hesitate to contact us on [our Discord channel](https://monerium.com/invite/discord).
