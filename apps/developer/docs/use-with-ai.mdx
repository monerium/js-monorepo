...
**Download:** [/llms/oauth.md](/llms/oauth.md)
...
**Download:** [/llms/whitelabel.md](/llms/whitelabel.md)
...
**Download:** [/llms/private.md](/llms/private.md)
...
At the top of the file add: `@/llms/whitelabel.md` (or whichever plan applies) and your AI assistant will automatically have Monerium context for every conversation in that project.

A ready-made Cursor rules file is also available at [/llms/cursor-rules.md](/llms/cursor-rules.md) — copy it to `.cursor/rules/monerium.mdc` in your project.
