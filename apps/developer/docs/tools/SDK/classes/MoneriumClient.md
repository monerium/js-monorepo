...
> **getProfile**(`profileId`): `Promise`\<[`Profile`](/docs/tools/SDK/interfaces/Profile.md)\>
...
> **uploadSupportingDocument**(`document`): `Promise`\<[`SupportingDoc`](/docs/tools/SDK/interfaces/SupportingDoc.md)\>
